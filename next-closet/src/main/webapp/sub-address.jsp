	  ...
	  <div class="container">
		  <div class="split left-box">
			...
			<form action="SubAddressServlet" method="post">
				<label>郵便番号</label><br><input type="text" name="postcode" placeholder="例)　&#12306; 0000000" required><br> 
				<label>都道府県</label><br>
				<select name="prefectures" required>
			     ...
			     <label>住所</label><br>
			     <input class="address" type="text" name="address" placeholder="例) 〇〇市〇〇区〇丁目" required></input>
		  	</div>
			...
			<div class="split right-box">
				...
				<% if(addressList == null) { %>
					...
					<form action="AddressDeleteServlet" method="post">
						<div>
					     <input class="add_list" type="checkbox" name="addAddressId" value='<%= addresses.getAddAddressId()%>'> <!-- サブ住所のIDを値として返す -->
	   ...
	   <div class="center">
	   		<a class="back" href="MypageServlet">マイページに戻る</a>
	   </div>
